...
with open("tests/unit_type/add.json") as file:
...
class TestJenisUnit():
    ...
    def mocked_requests_aturtagihan_get_all_jenis_unit(*args, **kwargs):
        ...
        if len(args) > 0:
            ...
            elif args[0] == "https://magellan.sumpahpalapa.com/api/v1/unit_type":
    ...
    def test_add_jenis_unit(self, get_mock, client):
        # PENGATURAN
    ...
    def test_add_jenis_unit_produk_kosong(self, get_mock, client):
        # PENGATURAN
        data = send_message("6281320003997", "pengaturan")
        res = client.post('/webhooks/inbound-message',
                            data=json.dumps(data),
    ...
    # PRODUK 100
    @mock.patch('requests.post', side_effect=mocked_requests_aturtagihan_get_all_jenis_unit)
    def test_add_jenis_unit_produk_100(self, get_mock, client):
        # PENGATURAN
        data = send_message("6281320003997", "pengaturan")
        res = client.post('/webhooks/inbound-message',
                            data=json.dumps(data),
